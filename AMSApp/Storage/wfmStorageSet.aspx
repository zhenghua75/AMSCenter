<%@ Page language="c#" Codebehind="wfmStorageSet.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.Storage.wfmStorageSet" %>
					...
					<TD>
						<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="100%" border="0">
							<TR>
								...
								<TD style="WIDTH: 149px"><asp:dropdownlist id="ddlDept" runat="server" Font-Size="10pt" Width="160px" AutoPostBack="true" onselectedindexchanged="ddlDept_SelectedIndexChanged"></asp:dropdownlist></TD>
							...
							<TR>
								...
								<TD style="WIDTH: 149px"><asp:dropdownlist id="ddlProductType" runat="server" Font-Size="10pt" Width="160px" AutoPostBack="true" onselectedindexchanged="ddlProductType_SelectedIndexChanged"></asp:dropdownlist></TD>
								...
								<TD style="WIDTH: 114px"><asp:button id="btQuery" runat="server" Font-Size="10pt" Width="56px" Text="查询" onclick="btQuery_Click"></asp:button></TD>
								<TD style="WIDTH: 16px"></TD>
							</TR>
						</TABLE>
					</TD>
