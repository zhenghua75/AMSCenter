<%@ Page language="c#" Codebehind="wfmBillOfReceive.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.Storage.wfmBillOfReceive" %>
		...
		<FORM id="Form1" method="post" runat="server">
            ...
            style="WIDTH: 112px; HEIGHT: 22px" onfocus=HS_setDate(this) readOnly type=text size=13 value="<%=strBeginDate%>" name=txtBegin></FONT></TD>
								<TD style="WIDTH: 99px; HEIGHT: 8px">
									<asp:button id="btnQuery" runat="server" Width="64px" Text="查询" onclick="btnQuery_Click"></asp:button></TD>
								<TD style="WIDTH: 157px; HEIGHT: 8px">
									<asp:button id="btnRelativeMakeBill" runat="server" Width="112px" Text="关联制令领料单" onclick="Button1_Click"></asp:button></TD>
            ...
            style="WIDTH: 112px; HEIGHT: 22px" onfocus=HS_setDate(this) readOnly type=text size=13 value="<%=strEndDate%>" name=txtEnd></FONT></TD>
								...
								<TD style="WIDTH: 157px">
									<asp:button id="btnAddNonMake" runat="server" Width="112px" Text="门店领料单" onclick="btnAdd_Click"></asp:button></TD>
								<TD style="WIDTH: 101px"><FONT face="宋体">
										<asp:button id="btnSend" runat="server" Width="56px" Text="发货" onclick="btnSend_Click"></asp:button></FONT></TD>
								<TD style="HEIGHT: 8px"><FONT face="宋体">
										<asp:button id="btnPrint" runat="server" Width="80px" Text="打印发货单" onclick="btnPrint_Click"></asp:button></FONT></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
