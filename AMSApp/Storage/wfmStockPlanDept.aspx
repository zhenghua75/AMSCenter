<%@ Page language="c#" Codebehind="wfmStockPlanDept.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.Storage.wfmStockPlanDept" %>
	...
	<body MS_POSITIONING="GridLayout" bgColor="#feeff8">
		<FORM id="Form1" method="post" runat="server">
						...
						<TABLE id="Table6" cellSpacing="1" cellPadding="1" width="100%" border="0">
							<TR>
								...
								<TD style="WIDTH: 188px">
									<asp:dropdownlist id="ddlProduct" runat="server" Font-Size="10pt" AutoPostBack="true" Width="184px" onselectedindexchanged="ddlProduct_SelectedIndexChanged"></asp:dropdownlist></TD>
								...
								<TD style="WIDTH: 78px" align="right"><FONT face="宋体">
										<asp:button id="btnQuery" runat="server" Font-Size="10pt" Width="61px" Text="查询" onclick="btnQuery_Click"></asp:button></FONT></TD>
								<TD style="WIDTH: 62px" align="right">
									<asp:button id="Button1" runat="server" Font-Size="10pt" Width="61px" Text="取消" onclick="Button1_Click"></asp:button></TD>
							</TR>
							<TR>
								...
								<TD style="WIDTH: 62px" align="right">
									<asp:button id="btnNewPlan" runat="server" Font-Size="10pt" Width="80px" Text="确定计划" BorderColor="LemonChiffon"
										BackColor="Orange" onclick="btnNewPlan_Click"></asp:button></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
			...
			<TABLE id="Table4" cellSpacing="1" cellPadding="1" width="95%" border="0">
				<tr>
					<td align="right">
						<asp:button id="btnAdd" runat="server" Font-Size="10pt" Width="80px" Text="添加单品" onclick="btnAdd_Click"></asp:button></td>
				</tr>
				<TR>
					<TD align="center">
