<%@ Page language="c#" Codebehind="wfmMakeBillRelativeReceive.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.Storage.wfmMakeBillRelativeReceive" %>
					...
					<TD>
						<TABLE id="Table2" cellSpacing="0" cellPadding="1" width="100%" border="0">
							...
							<TR>
								...
								<TD style="WIDTH: 128px"><asp:button id="btnRelativeMakeToReceive" runat="server" Width="72px" Text="确定关联" onclick="btnRelativeMakeToReceive_Click"></asp:button></TD>
								<td>
									<asp:button id="btnReturn" runat="server" Width="64px" Text="返回" onclick="btnReturn_Click"></asp:button></td>
							</TR>
						</TABLE>
					</TD>
				</TR>
