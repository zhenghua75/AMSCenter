<%@ Page language="c#" Codebehind="wfmBillOfReceiveSend.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.Storage.wfmBillOfReceiveSend" %>
					...
					<TD>
						<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="100%" border="0">
							<TR>
								...
								<TD style="WIDTH: 129px"><asp:button id="btnQuery" runat="server" Font-Size="10pt" Width="56px" Text="查询" onclick="btnQuery_Click"></asp:button></TD>
								<TD><FONT face="宋体"><asp:button id="btnCancel" runat="server" Font-Size="10pt" Width="56px" Text="返 回" onclick="btnCancel_Click"></asp:button></FONT></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
			...
			<TABLE id="Table6" cellSpacing="1" cellPadding="1" width="100%" border="0">
				<tr>
					...
					<td align="right"><asp:button id="btnSendOK" runat="server" Font-Size="10pt" Width="95px" Text="确认发货" BorderColor="LemonChiffon"
							BackColor="Orange" onclick="btnSendOK_Click"></asp:button></td>
				</tr>
			</TABLE>
			<TABLE id="Table5" cellSpacing="1" cellPadding="1" border="0" width="120%">
				<tr>
					...
					<td>
						<asp:button id="btnPrint" runat="server" Text="打印发货单" Width="86px" Font-Size="10pt" onclick="btnPrint_Click"></asp:button></td>
				</tr>
				<TR>
					...
					<TD align="left" colspan="2"><asp:datagrid id="DataGrid3" runat="server" Font-Size="X-Small" Width="100%" AutoGenerateColumns="False"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="cnvcMDDL1" ReadOnly="True" HeaderText="东来店"></asp:BoundColumn>
								<asp:BoundColumn DataField="cnvcYG001" ReadOnly="True" HeaderText="阳光花园店"></asp:BoundColumn>
								<asp:BoundColumn DataField="cnvcMDLX1" ReadOnly="True" HeaderText="理想小镇店"></asp:BoundColumn>
