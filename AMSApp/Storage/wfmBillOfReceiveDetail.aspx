<%@ Page language="c#" Codebehind="wfmBillOfReceiveDetail.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.Storage.wfmBillOfReceiveDetail" %>
						...
						<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="100%" border="0">
							<TR>
								...
								<TD style="WIDTH: 101px" align="left">
									<asp:button id="btnQueryFilter" runat="server" Font-Size="10pt" Width="54px" Text="查询" onclick="btnQueryFilter_Click"></asp:button></TD>
							...
							<TR>
								...
								<TD style="WIDTH: 189px">
									<asp:dropdownlist id="ddlBillType" runat="server" Font-Size="10pt" Width="181px" AutoPostBack="true" onselectedindexchanged="ddlBillType_SelectedIndexChanged"></asp:dropdownlist></TD>
            ...
            style="WIDTH: 148px; HEIGHT: 22px" onfocus=HS_setDate(this) readOnly type=text size=18 value="<%=strBeginDate%>" name=txtBegin></TD>
								<TD>
									<asp:button id="btnReceiveNew" runat="server" Font-Size="10pt" Width="88px" Text="领料单-预领" BorderColor="LemonChiffon"
										BackColor="Orange" onclick="btnReceiveNew_Click"></asp:button></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 87px" align="right">
								...
								<TD>
									<asp:button id="btnPrint" runat="server" Font-Size="10pt" Width="56px" Text="打 印" onclick="btnPrint_Click"></asp:button></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 87px" align="right">
								...
								<TD><FONT face="宋体">
										<asp:button id="btnCancel" runat="server" Font-Size="10pt" Width="56px" Text="返 回" onclick="btnCancel_Click"></asp:button></FONT></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
						...
						<TABLE id="Table6" cellSpacing="1" cellPadding="1" width="100%" border="0">
							<TR>
								...
								<TD style="WIDTH: 339px">
									<asp:dropdownlist id="ddlMaterialType" runat="server" Font-Size="10pt" Width="189px" AutoPostBack="true" onselectedindexchanged="ddlMaterialType_SelectedIndexChanged"></asp:dropdownlist></TD>
								<TD style="WIDTH: 154px" align="right">
									<asp:label id="Label1" runat="server" Font-Size="10pt" Width="80px">原材料名称：</asp:label></TD>
								<TD style="WIDTH: 347px">
									<asp:dropdownlist id="ddlProduct" runat="server" Font-Size="10pt" Width="189px" AutoPostBack="true" onselectedindexchanged="ddlProduct_SelectedIndexChanged"></asp:dropdownlist></TD>
							...
							<TR>
								...
								<TD style="WIDTH: 62px" align="right">
									<asp:button id="btnAdd" runat="server" Font-Size="10pt" Width="72px" Text="添加产品" onclick="btnAdd_Click"></asp:button></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
