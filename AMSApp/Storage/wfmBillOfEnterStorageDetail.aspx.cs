...
namespace AMSApp.Storage
{
	...
	/// </summary>
	public partial class wfmBillOfEnterStorageDetail : wfmBase
	{
		...
		protected void btnEnterNew_Click(object sender, System.EventArgs e)
		{
			strBeginDate = Request.Form["txtBegin"].ToString();
		...
		protected void ddlProvider_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			this.ddlProduct.Items.Clear();
			string strProvider=this.ddlProvider.SelectedValue;
			Hashtable htapp=(Hashtable)Application["appconf"];
		...
		protected void btnQueryFilter_Click(object sender, System.EventArgs e)
		{
