<%@ Page language="c#" Codebehind="wfmPlanBatchDetail.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.Storage.wfmPlanBatchDetail" %>
      ...
      style="WIDTH: 136px; HEIGHT: 22px" onfocus=HS_setDate(this) readOnly type=text size=17 value="<%=strBeginDate%>" name=txtBegin></TD>
				...
				<TR>
					...
					<TD style="WIDTH: 90px" align="center">
						<asp:Button id="btcancel" runat="server" Width="68px" Font-Size="10pt" Text="返回" onclick="btcancel_Click"></asp:Button></TD>
					<TD align="center"></TD>
				</TR>
			</TABLE>
		</FORM>
