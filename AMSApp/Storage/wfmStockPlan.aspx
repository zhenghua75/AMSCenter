...
<%@ Page language="c#" Codebehind="wfmStockPlan.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.Storage.wfmStockPlan" %>
						...
						<TABLE id="Table2" cellSpacing="0" cellPadding="1" width="100%" border="0">
							<TR>
								...
								<TD style="HEIGHT: 26px">
									<asp:button id="btnAdd" runat="server" Width="112px" Text="添加部门计划" onclick="btnAdd_Click"></asp:button></TD>
							</TR>
							<TR>
