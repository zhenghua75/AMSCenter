<%@ Page language="c#" Codebehind="wfmDestroyConfirm.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.Storage.wfmDestroyConfirm" %>
		...
		<FORM id="Form1" method="post" runat="server">
			...
			<TABLE id="Table4" cellSpacing="1" cellPadding="1" width="100%" border="0">
				<tr>
					...
					<td style="WIDTH: 201px" align="center"><asp:button id="btnAllSelect" runat="server" Width="104px" Text="单页全选" onclick="btnAllSelect_Click"></asp:button></td>
					<td align="center"><asp:button id="btnBatchConfirm" runat="server" Width="80px" Text="确认提交" onclick="btnBatchConfirm_Click"></asp:button></td>
					<td width="150"></td>
				</tr>
				<TR>
