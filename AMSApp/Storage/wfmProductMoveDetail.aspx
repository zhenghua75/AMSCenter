<%@ Page language="c#" Codebehind="wfmProductMoveDetail.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.Storage.wfmProductMoveDetail" %>
            ...
            ></TD>
							...
							<TR>
								...
								<TD style="WIDTH: 127px" align="right"><asp:button id="btnMoveNew" runat="server" Font-Size="10pt" Width="88px" BackColor="Orange"
										BorderColor="LemonChiffon" Text="调拨单-发货" onclick="btnMoveNew_Click"></asp:button></TD>
								<TD style="WIDTH: 124px" align="center"><asp:button id="btnPrint" runat="server" Font-Size="10pt" Width="54px" Text="打印" onclick="btnPrint_Click"></asp:button></TD>
								<TD style="WIDTH: 107px" align="right"><FONT face="宋体">
										<asp:button id="btnCancel" runat="server" Font-Size="10pt" Width="54px" Text="返回" onclick="btnCancel_Click"></asp:button></FONT></TD>
								<td></td>
							</TR>
						</TABLE>
					</TD>
					...
					<TD>
						<TABLE id="Table6" cellSpacing="1" cellPadding="1" width="100%" border="0">
							<TR>
								...
								<TD style="WIDTH: 58px"><asp:dropdownlist id="ddlProduct" runat="server" Font-Size="10pt" Width="195px" AutoPostBack="true" onselectedindexchanged="ddlProduct_SelectedIndexChanged"></asp:dropdownlist></TD>
							...
							<TR>
								...
								<TD style="WIDTH: 158px" align="center"><asp:button id="btnAdd" runat="server" Font-Size="10pt" Width="72px" Text="添加产品" onclick="btnAdd_Click"></asp:button></TD>
