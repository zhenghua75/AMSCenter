<%@ Page language="c#" Codebehind="wfmPrintReceiveSend.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.Storage.wfmPrintReceiveSend" %>
						...
						<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="100%" border="0">
							<TR>
								...
								<TD style="WIDTH: 107px" align="left">
									<asp:button id="btnQuery" runat="server" Text="查询" Width="56px" Font-Size="10pt" onclick="btnQuery_Click"></asp:button></TD>
								<TD style="WIDTH: 115px" align="left">
									<asp:button id="btnPrint" runat="server" Text="打印" Width="56px" Font-Size="10pt" onclick="btnPrint_Click"></asp:button></TD>
								<TD><asp:button id="btnCancel" runat="server" Font-Size="10pt" Width="56px" Text="返 回" onclick="btnCancel_Click"></asp:button></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 160px" align="right"></TD>
