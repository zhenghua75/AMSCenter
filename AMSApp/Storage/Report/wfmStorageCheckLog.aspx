...
<%@ Page language="c#" Codebehind="wfmStorageCheckLog.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.Storage.Report.wfmStorageCheckLog" %>
		...
		<FORM id="Form1" method="post" runat="server">
            ...
            value="<%=strEndDate%>" name=txtEnd></td>
							...
							<TR>
								...
								<TD style="WIDTH: 127px"><asp:dropdownlist id="ddlProductType" runat="server" Font-Size="10pt" Width="160px" AutoPostBack="true" onselectedindexchanged="ddlProductType_SelectedIndexChanged"></asp:dropdownlist></TD>
								<TD style="WIDTH: 53px"></TD>
