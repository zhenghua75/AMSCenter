...
<%@ Page language="c#" Codebehind="wfmEnterStorageReport.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.Storage.Report.wfmEnterStorageReport" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>wfmEnterStorageReport</title>
	...
	<body MS_POSITIONING="GridLayout" bgcolor="#feeff8">
		<FORM id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="1" cellPadding="5" width="95%" border="0">
				<TR>
					<TD align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 15pt; COLOR: #330033">进仓报表</TD>
				</TR>
			</TABLE>
					...
					<td>
						<TABLE id="Table2" cellSpacing="0" cellPadding="1" width="100%" border="0" style="FONT-SIZE: 10pt">
							<TR>
								...
								<TD style="HEIGHT: 29px"><asp:button id="btnQuery" runat="server" Width="64px" Text="查询" onclick="btnQuery_Click"></asp:button></TD>
								<TD style="HEIGHT: 29px"></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 150px" align="right">
									<asp:label id="Label1" runat="server" Width="72px" Font-Size="10pt">供应商编码</asp:label></TD>
								<TD style="WIDTH: 127px">
									<asp:textbox id="txtProviderID" runat="server" Width="192px" Font-Size="10pt" Height="24px"></asp:textbox></TD>
								<TD style="WIDTH: 53px"></TD>
								<TD style="WIDTH: 96px" align="right">
									<asp:label id="Label4" runat="server" Width="72px" Font-Size="10pt">供应商名称</asp:label></TD>
								<td style="WIDTH: 193px">
									<asp:textbox id="txtProviderName" runat="server" Width="192px" Font-Size="10pt" Height="24px"></asp:textbox></td>
								<TD>
							...
							<TR>
								...
								<TD style="WIDTH: 127px">
									<asp:DropDownList id="ddlMaterialType" runat="server" Width="192px" AutoPostBack="True" onselectedindexchanged="ddlMaterialType_SelectedIndexChanged"></asp:DropDownList></TD>
								<TD style="WIDTH: 53px"></TD>
								<TD style="WIDTH: 96px" align="right">
