<%@ Page language="c#" Codebehind="wfmProductMove.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.Storage.wfmProductMove" %>
	...
	<body MS_POSITIONING="GridLayout" bgcolor="#feeff8">
		<FORM id="Form1" method="post" runat="server">
            ...
            style="WIDTH: 112px; HEIGHT: 22px" onfocus=HS_setDate(this) readOnly type=text size=13 value="<%=strBeginDate%>" name=txtBegin></FONT></TD>
								...
								<TD>
									<asp:button id="btnAdd" runat="server" Width="80px" Text="新调拨单" onclick="btnAdd_Click"></asp:button></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 160px" align="right">
