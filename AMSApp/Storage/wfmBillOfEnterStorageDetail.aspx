<%@ Page language="c#" Codebehind="wfmBillOfEnterStorageDetail.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.Storage.wfmBillOfEnterStorageDetail" %>
						...
						<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="100%" border="0">
							<TR>
								...
								<TD style="WIDTH: 128px; HEIGHT: 6px" align="left">
									<asp:button id="btnQueryFilter" runat="server" Width="54px" Font-Size="10pt" Text="查询" onclick="btnQueryFilter_Click"></asp:button></TD>
							...
							<TR>
								...
								<TD style="WIDTH: 188px"><asp:dropdownlist id="ddlProvider" runat="server" Font-Size="10pt" AutoPostBack="true" Width="181px" onselectedindexchanged="ddlProvider_SelectedIndexChanged"></asp:dropdownlist></TD>
							...
							<TR>
								...
								<TD style="WIDTH: 128px" align="right"><FONT face="宋体"><asp:button id="btnEnterNew" runat="server" Font-Size="10pt" Width="96px" Text="进仓单-确定" BorderColor="LemonChiffon"
											BackColor="Orange" ForeColor="ControlText" onclick="btnEnterNew_Click"></asp:button></FONT></TD>
								<TD style="WIDTH: 202px" align="center"><FONT face="宋体">
										<asp:button id="btnCancel" runat="server" Width="54px" Font-Size="10pt" Text="返回" onclick="btnCancel_Click"></asp:button></FONT></TD>
								<td style="WIDTH: 144px">
									<asp:button id="btnPrint" runat="server" Width="54px" Font-Size="10pt" Text="打印" onclick="btnPrint_Click"></asp:button></td>
								<TD style="WIDTH: 421px; HEIGHT: 6px"></TD>
							</TR>
						</TABLE>
					</TD>
					...
					<TD>
						<TABLE id="Table6" cellSpacing="1" cellPadding="1" width="100%" border="0">
							<TR>
								...
								<TD style="WIDTH: 168px"><asp:dropdownlist id="ddlProduct" runat="server" Font-Size="10pt" AutoPostBack="true" Width="160px" onselectedindexchanged="ddlProduct_SelectedIndexChanged"></asp:dropdownlist></TD>
							...
							<TR>
								...
								<TD style="WIDTH: 62px" align="right">
									<asp:button id="btnAdd" runat="server" Width="72px" Font-Size="10pt" Text="添加产品" onclick="btnAdd_Click"></asp:button></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
