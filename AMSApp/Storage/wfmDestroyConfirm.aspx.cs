...
namespace AMSApp.Storage
{
	...
	/// </summary>
	public partial class wfmDestroyConfirm :wfmBase
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(Session["Login"]!=null)
			{
				...
				if (!IsPostBack )
				{
					...
					this.ddlLoseType.Items.Add(new ListItem("运输损耗","运输损耗"));
					this.ddlLoseType.Items.Add(new ListItem("验收不合格","验收不合格"));
...
//		}
		...
		protected void btnAllSelect_Click(object sender, System.EventArgs e)
		{
			CheckBox chk1;
