...
<%@ Page language="c#" Codebehind="wfmBillOfEnterStorage.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.Storage.wfmBillOfEnterStorage" %>
	...
	<body MS_POSITIONING="GridLayout" bgcolor="#feeff8">
		<FORM id="Form1" method="post" runat="server">
            ...
            name=txtBegin style="WIDTH: 112px; HEIGHT: 22px"></FONT></TD>
								...
								<TD style="WIDTH: 78px"><asp:button id="btnQuery" runat="server" Width="64px" Text="查询" onclick="btnQuery_Click"></asp:button></TD>
								<TD><asp:button id="btnAdd" runat="server" Width="80px" Text="新进仓单" onclick="btnAdd_Click"></asp:button></TD>
							</TR>
							<TR>
