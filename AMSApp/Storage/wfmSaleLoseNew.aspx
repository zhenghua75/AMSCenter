<%@ Page language="c#" Codebehind="wfmSaleLoseNew.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.Storage.wfmSaleLoseNew" %>
	...
	<body bgColor="#feeff8" MS_POSITIONING="GridLayout">
		<FORM id="Form1" method="post" runat="server">
					...
					<TD>
						<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="100%" border="0">
							<TR>
								...
								<TD style="WIDTH: 232px"><asp:button id="btnCancel" runat="server" Font-Size="10pt" Width="56px" Text="返回" onclick="btnCancel_Click"></asp:button></TD>
					...
					<TD>
						<TABLE id="Table6" cellSpacing="1" cellPadding="1" width="100%" border="0">
							<TR>
								...
								<TD style="WIDTH: 217px"><asp:dropdownlist id="ddlProductType" runat="server" Font-Size="10pt" Width="184px" AutoPostBack="true" onselectedindexchanged="ddlProductType_SelectedIndexChanged"></asp:dropdownlist></TD>
								<TD style="WIDTH: 95px" align="right"><asp:label id="Label2" runat="server" Font-Size="10pt">产品类别：</asp:label></TD>
								<TD style="WIDTH: 180px"><asp:dropdownlist id="ddlProductClass" runat="server" Font-Size="10pt" Width="180px" AutoPostBack="true" onselectedindexchanged="ddlProductClass_SelectedIndexChanged"></asp:dropdownlist></TD>
								<TD style="WIDTH: 109px" align="right"><FONT face="宋体"><asp:label id="Label1" runat="server" Font-Size="10pt">产品名称：</asp:label></FONT></TD>
								<TD style="WIDTH: 237px"><asp:dropdownlist id="ddlProductName" runat="server" Font-Size="10pt" Width="189px" AutoPostBack="true" onselectedindexchanged="ddlProductName_SelectedIndexChanged"></asp:dropdownlist></TD>
								<TD style="WIDTH: 127px" align="left"><asp:button id="btnLoseAdd" runat="server" Font-Size="10pt" Width="56px" Text="添加" onclick="btnLoseAdd_Click"></asp:button></TD>
			...
			<TABLE id="Table4" cellSpacing="1" cellPadding="1" width="95%" border="0">
				<tr>
					<td align="right"><asp:button id="btnAllOK" runat="server" Font-Size="10pt" Width="84px" Text="确认提交" onclick="btnAllOK_Click"></asp:button></td>
				</tr>
				<TR>
