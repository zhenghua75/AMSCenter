...
namespace AMSApp.Storage
{
	...
	/// </summary>
	public partial class wfmBillOfReceiveDetail : wfmBase
	{
...
//							this.btnReceiveNew.Attributes.Add("onclick","return confirm('请确认你已经正确填写了\"发货量\"，并已将本领料单发货。\\n\\n确认发货？');");
		...
		protected void btnReceiveNew_Click(object sender, System.EventArgs e)
		{
			strBeginDate = Request.Form["txtBegin"].ToString();
		...
		protected void ddlBillType_SelectedIndexChanged(object sender, System.EventArgs e)
		{
