...
namespace AMSApp.Storage
{
	...
	/// </summary>
	public partial class wfmStockPlanDept : wfmBase
	{
...
//					DataRow[] drs = dtmaterial.Select("vcCommCode='"+this.ddlProduct.SelectedValue+"'");
//					if(drs.Length > 0)
...
//			DataRow[] drs = dtmaterial.Select("vcCommCode='"+this.ddlProduct.SelectedValue+"'");
//			if(drs.Length > 0)
//				this.txtUnit.Text=drs[0]["cnvcStandardUnit"].ToString();
		}
	}
}
