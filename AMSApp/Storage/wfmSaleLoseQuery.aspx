<%@ Page language="c#" Codebehind="wfmSaleLoseQuery.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.Storage.wfmSaleLoseQuery" %>
...
<HTML>
	...
	<body bgColor="#feeff8" MS_POSITIONING="GridLayout">
		<FORM id="Form1" method="post" runat="server">
            ...
            ></TD>
								<TD style="WIDTH: 103px"><FONT face="宋体"><asp:button id="btQuery" runat="server" Font-Size="10pt" Width="56px" Text="查询" onclick="btQuery_Click"></asp:button></FONT></TD>
								<TD style="WIDTH: 114px"><asp:button id="btnAdd" runat="server" Font-Size="10pt" Width="56px" Text="添加" onclick="btnAdd_Click"></asp:button></TD>
