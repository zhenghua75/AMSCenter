<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfmConsItemUndo.aspx.cs"
    Inherits="AMSApp.BusiQuery.wfmConsItemUndo" %>
                ...
                <td>
                    <table id="Table3" cellspacing="1" cellpadding="1" width="100%" border="0">
                        <tr>
                            ...
                            <td style="width: 81px" align="right">
                                <asp:Label ID="Label1" runat="server" Text="是否撤销" Font-Size="10pt"></asp:Label>
                            </td>
                            <td style="width: 142px">
            ...
            <tr>
                <td align="center">
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" CellPadding="4" ForeColor="#333333"
                        ...
                        onrowdatabound="GridView1_RowDataBound" ShowFooter="True" PageSize="100">
                        ...
                        <Columns>
                            ...
                            <asp:CommandField EditText="零售撤销" ShowEditButton="True" UpdateText="确定" />
                            <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Delete"
                                        Text="取消撤销" OnClientClick="return confirm('取消撤销?');"></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
