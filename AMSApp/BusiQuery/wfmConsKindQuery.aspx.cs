...
namespace AMSApp.BusiQuery
{
	...
	/// </summary>
	public partial class wfmConsKindQuery : wfmBase
	{
...
//				}
		...
		protected void chbAssType_CheckedChanged(object sender, System.EventArgs e)
		{
		...
		protected void chbGoodsType_CheckedChanged(object sender, System.EventArgs e)
		{
		...
		protected void chbDept_CheckedChanged(object sender, System.EventArgs e)
		{
			if(chbDept.Checked)
			{
		...
		protected void btQuery_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				dtout = busiq.GetConsKindQuery(htPara,querytype,chbDate.Checked,chbAssType.Checked,chbGoodsType.Checked,chbDept.Checked);
				if(dtout==null)
				{
				...
				if(dtout.Columns.Contains("门店"))
				{
					this.TableConvert(dtout,"门店","tbCommCode","vcCommSign ='MD'");
				}
				if(dtout.Columns.Contains("会员类型"))
				{
