<%@ Page language="c#" Codebehind="wfmLoginPwd.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.paraconf.wfmLoginPwd" %>
			...
			<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="561" align="center" border="1"
				...
				<TR>
					...
					<TD width="60%" align="center">
						<asp:Button id="btClose" runat="server" Width="64px" Font-Size="10pt" Text="关闭" onclick="btClose_Click"></asp:Button></TD>
				</TR>
			</TABLE>
		</FORM>
	</body>
