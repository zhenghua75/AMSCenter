<%@ Page language="c#" Codebehind="wfmDeptManage.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.paraconf.wfmDeptManage" %>
				...
				<TR>
					<TD align="center"><asp:datagrid id="DataGrid1" runat="server" Font-Size="X-Small" Width="100%" PagerStyle-HorizontalAlign="Right"
							...
							<Columns>
                                ...
                                <asp:BoundColumn DataField="vcRegion" HeaderText="片区"></asp:BoundColumn>
                                <asp:BoundColumn DataField="vcTel" HeaderText="电话"></asp:BoundColumn>
