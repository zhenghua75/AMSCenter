<%@ Page language="c#" Codebehind="wfmNoticeDetail2.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.paraconf.wfmNoticeDetail2" %>
						...
						<TABLE id="Table2" cellSpacing="0" cellPadding="1" width="100%" border="0">
							<TR>
								<TD style="WIDTH: 101px" align="right">
									<asp:Label id="Label2" runat="server" Font-Size="10pt">失效日期</asp:Label></TD>
								<TD style="WIDTH: 538px">
									<asp:TextBox id="txtInvalidDate" runat="server" onfocus="HS_setDate(this)" ></asp:TextBox></TD>
							</TR>
							<TR>
							...
							<TR>
								...
								<TD align="center">
									...
									<asp:button id="btcancel" runat="server" Width="101px" Text="返回通知管理" onclick="btcancel_Click"></asp:button></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
