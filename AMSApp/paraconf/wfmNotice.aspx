<%@ Page language="c#" Codebehind="wfmNotice.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.paraconf.wfmNotice" %>
							...
							<TABLE id="Table2" cellSpacing="0" cellPadding="1" width="100%" border="0">
								...
								<TR>
									...
									<TD style="WIDTH: 324px">
										<asp:button id="btAdd" runat="server" Width="64px" Text="添加" onclick="btAdd_Click"></asp:button></TD>
									<TD style="WIDTH: 94px">
