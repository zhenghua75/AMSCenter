...
namespace AMSApp.paraconf
{
	...
	/// </summary>
	public partial class wfmNoticeDetail2 : wfmBase
	{
...
//				this.FillDropDownList("tbCommCode", ddlDept, "vcCommSign ='MD'","全部门店");
		...
		private void InitCtrl()
		{
			...
			this.txtInvalidDate.Text = DateTime.Now.ToString("yyyy-MM-dd");				
		}
...
//			}
			...
			string strInvalidDate = txtInvalidDate.Text;
			string strsql = "insert into tbNotice(cnvcComments,cndReleaseDate,cndInvalidDate,cnvcIsActive) values "
				+ " ('"+strContent+"',getdate(),'"+strInvalidDate+"','1')";
...
//			}
		...
		{
			Response.Redirect("wfmNotice2.aspx");
		}
	}
}
