...
namespace AMSApp
{
	...
	/// wfmFileUp 的摘要说明。
	/// </summary>
	public partial class wfmFileUp : wfmBase
	{
		...
		protected void btnReadFile_Click(object sender, System.EventArgs e)
		{
			try
			{
				if(txtSheet.Text == "")
		...
		protected void btnWriteFile_Click(object sender, System.EventArgs e)
		{
			try
			{
