...
//		public static DataTable BindNameCode(string strType)
//		{
//			SqlConnection conn = ConnectionPool.BorrowConnection();
//			DataTable dtRet = null;
//			try
//			{
//				dtRet = SqlHelper.ExecuteDataTable(conn, CommandType.Text, "select * from tbNameCode where cnvcType = '"+strType+"'");
//			}
//			catch(Exception ex)
//			{
//				LogAdapter.WriteFeaturesException(ex);	
