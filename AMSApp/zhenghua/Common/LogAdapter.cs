	...
	public class LogAdapter
	{
		...
		public static void WriteInterfaceException(Exception e)
		{
            ...
            if (e.InnerException != null)
            {
                ...
                sw.WriteLine();
                sw.WriteLine("InnerException-Message:" + e.InnerException.Message);
                sw.WriteLine("InnerException-Source :" + e.InnerException.Source);
                sw.WriteLine();
                sw.WriteLine("InnerException-Detail :");
