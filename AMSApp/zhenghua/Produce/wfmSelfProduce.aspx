<%@ Page language="c#" Codebehind="wfmSelfProduce.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.zhenghua.Produce.wfmSelfProduce" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table width="100%">
				<tr>
					...
					<td><asp:textbox id="txtShipDate" onfocus="WdatePicker()" runat="server" CssClass="textbox" ReadOnly="True"></asp:textbox></td>
				</tr>
				<tr>
					<td colSpan="6" align="center"><asp:button id="btnProductList" runat="server" CssClass="button" Text="产品清单" onclick="btnProductList_Click"></asp:button><asp:button id="btnProduce" runat="server" CssClass="button" Text="生产" onclick="btnProduce_Click"></asp:button><asp:button style="Z-INDEX: 0" id="btnStorage" runat="server" CssClass="button" Text="库存产品" onclick="btnStorage_Click"></asp:button><asp:button id="btnReturn" runat="server" CssClass="button" Text="返回" onclick="btnReturn_Click"></asp:button></td>
				</tr>
			</table>
