<%@ Page language="c#" Codebehind="wfmDividAdjust.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.zhenghua.Produce.wfmDividAdjust" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<table align="center">
				...
				<tr>
					<td colSpan="6" align="center"><asp:button id="btnQuery" runat="server" CssClass="button" Text="查询" onclick="btnQuery_Click"></asp:button><asp:button id="btnReturn" runat="server" CssClass="button" Text="返回" onclick="btnReturn_Click"></asp:button><asp:textbox id="txtProduceState" runat="server" Visible="False"></asp:textbox></td>
				</tr>
			</table>
