<%@ Page language="c#" Codebehind="wfmDividReport.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.zhenghua.Produce.wfmDividReport" %>
			...
			<table width="100%" align="center" class="Noprint">
				<tr>
					<td align="center">
						...
						<input class="button" value="打印" type="button" runat="server" id="btnPrint" onserverclick="btnPrint_ServerClick"> <input class="button" value="直接打印" type="button" runat="server" id="btnDPrint" onserverclick="btnDPrint_ServerClick">
						...
						<asp:TextBox id="txtAssignSerialNo" runat="server" Visible="False"></asp:TextBox></td>
					</TD></tr>
			</table>
			<table align="center" width="100%">
				<tr>
					<td colspan="3" align="center">
						<asp:Label id="Label8" runat="server" CssClass="title">面包工坊发货单</asp:Label></td>
				</tr>
				<tr>
					<td><asp:label id="Label9" runat="server">分货流水：</asp:label>
						<asp:label id="lblAssignSerialNo" runat="server"></asp:label></td>
					
					<td><asp:label id="Label11" runat="server">订单流水：</asp:label>
						<asp:label id="lblOrderSerialNo" runat="server"></asp:label></td>
						<td></td>
				</tr>
				<tr>
				...
				<tr>
					<td align="center" colspan="3">
						<asp:DataGrid id="DataGrid1" runat="server" AutoGenerateColumns="False" CssClass="datagrid" BorderColor="Black"
							...
							<Columns>
								<asp:BoundColumn DataField="cnvcProductName" HeaderText="品相"></asp:BoundColumn>
								<asp:BoundColumn DataField="cnnPrice" HeaderText="单价"></asp:BoundColumn>
								<asp:BoundColumn DataField="cnnCount" HeaderText="实发数量"></asp:BoundColumn>
