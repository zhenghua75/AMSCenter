<%@ Page language="c#" Codebehind="wfmProducePlanQueryGoods.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.zhenghua.Produce.wfmProducePlanQueryGoods" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table align="center">
				<tr>
					...
					<td><asp:textbox id="txtProduceBeginDate" onfocus="WdatePicker()" runat="server" CssClass="textbox"
							ReadOnly="True"></asp:textbox></td>
					<td><asp:label id="Label3" runat="server" CssClass="lable">结束日期：</asp:label></td>
					<td><asp:textbox id="txtProduceEndDate" onfocus="WdatePicker()" runat="server" CssClass="textbox" ReadOnly="True"></asp:textbox></td>
				</tr>
				<tr>
					<td colSpan="6" align="center"><asp:button id="btnQuery" runat="server" CssClass="button" Text="查询" onclick="btnQuery_Click"></asp:button><asp:button id="btnCancel" runat="server" CssClass="button" Text="取消" onclick="btnCancel_Click"></asp:button>
						<asp:Button id="btnDept" runat="server" Text="部门分货优先级调整" CssClass="button" Width="123px" onclick="btnDept_Click"></asp:Button></td>
				</tr>
			</table>
				...
				<tr>
					<td align="center"><asp:datagrid id="DataGrid1" runat="server" CssClass="datagrid" BorderColor="Black" BorderWidth="1px"
							...
							<Columns>
								...
								<asp:HyperLinkColumn Text="分货" Target="_self" DataNavigateUrlField="cnnProduceSerialNo" DataNavigateUrlFormatString="wfmDividGoods.aspx?OperType=Make&amp;ProduceSerialNo={0}"
									HeaderText="分货"></asp:HyperLinkColumn>
								<asp:HyperLinkColumn Text="分货报表" Target="_self" DataNavigateUrlField="cnnProduceSerialNo" DataNavigateUrlFormatString="wfmDividAdjust.aspx?ProduceSerialNo={0}"
									HeaderText="分货报表"></asp:HyperLinkColumn>
							</Columns>
