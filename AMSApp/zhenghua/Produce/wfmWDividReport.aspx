<%@ Page language="c#" Codebehind="wfmWDividReport.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.zhenghua.Produce.wfmWDividReport" %>
				...
				<tr>
					<td align="center" colspan="3">
						<asp:DataGrid id="DataGrid1" runat="server" AutoGenerateColumns="False" CssClass="datagrid" BorderColor="Black"
							...
							<Columns>
								<asp:BoundColumn DataField="cnvcProductName" HeaderText="品项"></asp:BoundColumn>
