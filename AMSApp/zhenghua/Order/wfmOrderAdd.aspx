<%@ Page language="c#" Codebehind="wfmOrderAdd.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.zhenghua.Order.wfmOrderAdd" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>wfmOrderAdd</title>
	...
	<body MS_POSITIONING="GridLayout" bgcolor="#feeff8">
		<form id="Form1" method="post" runat="server">
			<table align="center">
				<tr>
					<td>
						<asp:Label id="Label1" runat="server" CssClass="title">加单</asp:Label></td>
				</tr>
			</table>
			<table>
				<tr>
				...
				<tr>
					<td>
						<asp:Label CssClass="lable" id="Label2" runat="server">加单类型：</asp:Label></td>
					<td>
						<asp:DropDownList id="ddlAddType" runat="server"></asp:DropDownList></td>
				</tr>
				<tr>
					<td>
						<asp:Label id="Label3" runat="server" CssClass="lable">加单说明：</asp:Label></td>
					<td>
						<asp:TextBox id="txtAddComments" runat="server" TextMode="MultiLine" Height="70px" CssClass="textbox"></asp:TextBox></td>
				</tr>
			</table>
			<table>
				<tr>
