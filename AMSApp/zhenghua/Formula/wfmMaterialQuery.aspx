<%@ Page language="c#" Codebehind="wfmMaterialQuery.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.zhenghua.Formula.wfmMaterialQuery" %>
	...
	<body MS_POSITIONING="GridLayout" bgcolor="#feeff8">
		<form id="Form1" method="post" runat="server">
			...
			<table align="center">
				...
				<tr>
					<td colSpan="4" align="center"><asp:button id="btnQuery" runat="server" Text="查询" Width="60px" onclick="btnQuery_Click"></asp:button><asp:button id="btnCancel" runat="server" Text="取消" Width="60px" onclick="btnCancel_Click"></asp:button><asp:button id="btnReturn" runat="server" Text="返回" Width="60px" onclick="btnReturn_Click"></asp:button></td>
				</tr>
			</table>
			<table align="center">
				<tr>
