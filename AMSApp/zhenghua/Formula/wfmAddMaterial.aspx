<%@ Page language="c#" Codebehind="wfmAddMaterial.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.zhenghua.Formula.wfmAddMaterial" %>
		...
		<form id="Form1" method="post" runat="server">
			<table align="center">
				...
				<tr>
					...
					<td>
						<asp:DropDownList id="ddlProductType" runat="server" AutoPostBack="True" onselectedindexchanged="ddlProductType_SelectedIndexChanged"></asp:DropDownList></td>
				</tr>
				<tr>
					<td>
						<asp:Label id="Label12" runat="server">产品类别</asp:Label></td>
					<td>
						<asp:DropDownList id="ddlProductClass" runat="server" AutoPostBack="True" onselectedindexchanged="ddlProductClass_SelectedIndexChanged"></asp:DropDownList></td>
				</tr>
				<tr>
					<td colspan="2" align="center">
				...
				<tr>
					<td colspan="2" align="center">
						<asp:Button id="btnAdd" runat="server" Text="确定" CssClass="button" onclick="btnAdd_Click"></asp:Button>
