<%@ Page language="c#" Codebehind="wfmSuccess.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.wfmSuccess" %>
...
<HTML>
	...
	<body class="background_group" MS_POSITIONING="GridLayout">
		<form id="Success" method="post" runat="server">
			<table style="WIDTH: 600px; HEIGHT: 500px" height="500" align="center">
				<tr>
					<td>
