...
namespace AMSApp
{
	...
	{
        protected void BindRegion2(string strRegion, DropDownList ddl)
        {
            if (strRegion == "全部")
            {
                this.FillDropDownList("tbCommCode", ddl, "vcCommSign ='MD' and vcComments='门店" + strRegion + "'");
            }
            else
            {
                this.FillDropDownList("tbCommCode", ddl, "vcCommSign='MD' and vcCommCode<>'FYZX1' and vcComments like '门店|" + strRegion + "%'");
            }
        }
        ...
        protected void BindRegion(string strRegion, DropDownList ddl)
        {
            ...
            {
                this.FillDropDownList("tbCommCode", ddl, "vcCommSign='MD' and vcCommCode<>'FYZX1' and vcComments like '门店|" + strRegion + "%'", "全部");
            }
        }
        public void MonthList(DropDownList ddl,bool IsHaveNull)
        {
            string strvalue = "";
            ...
            for (int i = 0; i < 12; i++)
            {
                ...
                ListItem li = new ListItem { Text = strvalue, Value = strvalue };
                ddl.Items.Add(li);
            }
            //ddl.Items.Add(new ListItem { Text = "2012-03", Value = "2012-03" });
        }
		...
		public void StateDropDownList(string showItem,DropDownList ddl,string filter)
		{
			DataTable dt = (DataTable)Application[showItem];			
			if(dt==null)
			{
