<%@ Page language="c#" Codebehind="wfmFileUp.aspx.cs" AutoEventWireup="True" Inherits="AMSApp.wfmFileUp" %>
			...
			<table align="center">
				<tr>
					...
					<td><INPUT type="file" runat="server" id="fileUpLoad">
						<asp:Button id="btnReadFile" runat="server" Text="读取文件" onclick="btnReadFile_Click"></asp:Button></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2" align="center">
						<asp:Button id="btnWriteFile" runat="server" Text="导入文件" onclick="btnWriteFile_Click"></asp:Button>
						<asp:Button id="btnReturn" runat="server" Text="返回" Width="98px" onclick="btnReturn_Click"></asp:Button></td>
				</tr>
			</table>
